...
mysqldump --single-transaction --default-character-set=utf8mb4 -u login -pPassword nextcloud > /home/mount/Backup/nextcloud_db/nextcloud-sqlbkp_UTF8_`date +"%Y%m%d"`.bak
